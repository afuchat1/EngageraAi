...
// Same public Supabase project the Engagera web app talks to — the anon
// key is designed for client-side use and is scoped by Supabase RLS.
// Keeping this identical to artifacts/engagera/src/lib/supabase.ts means
// the mobile app shares accounts, conversations, and guest-message limits
// with the website without needing any app-specific backend or API key.
